...
class AppTheme extends ThemeBase {
  ...
  ColorScheme get colorSchemeLight => ColorScheme(
        ...
        onSecondary:
            AppSemanticColors.light.contentSecondary.withAlpha(255 ~/ 4),
        ...
        onSurface:
            AppSemanticColors.light.backgroundPrimary.withAlpha(255 ~/ 4),
  ...
  ColorScheme get colorSchemeDark => ColorScheme(
        ...
        onSecondary:
            AppSemanticColors.dark.contentSecondary.withAlpha(255 ~/ 4),
